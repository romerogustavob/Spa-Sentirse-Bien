      ...
      <div className="contenedor ">
      {
        ...
        <form onSubmit={onSubmit}>
          <label>
            ...
            <input className="textbox" type="email" {...register("email", {required: true})}></input>
            {errors.email && (
          ...
          <label>
            <p>Contraseña</p>
            <input className="textbox" type="password" {...register("password", { required: true})} />
            {errors.password && (
      ...
      <div className="contenedor R">
      {
        ...
        <form onSubmit={onSubmit}>
          <label>
            ...
            <input className="textbox" type="text" {...register("username", {required: true})}></input>
            {errors.username && (
          ...
          <label>
            ...
            <input className="textbox" type="password" {...register("password2", { required: true})} />
            {errors.password && (
